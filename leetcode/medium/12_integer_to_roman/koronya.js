...
//  Runtime: 156 ms, faster than 80.50% of JavaScript online submissions for Integer to Roman.
//  Memory Usage: 45.8 MB, less than 37.77% of JavaScript online submissions for Integer to Roman.
const getRoman = (num, digitNumber) => {
  if (num === 4) {
    switch (digitNumber) {
      default:
      case 0:
