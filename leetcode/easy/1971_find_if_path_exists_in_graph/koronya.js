...
// Runtime: 576 ms, faster than 100.00% of JavaScript online submissions for Find if Path Exists in Graph.
// Memory Usage: 103.9 MB, less than 100.00% of JavaScript online submissions for Find if Path Exists in Graph.
...
const validPath = function (n, edges, start, end) {
  ...
  const candidates = [...edgeMap.get(start)]
  while (candidates.length > 0) {
    ...
    const itemSet = edgeMap.get(item)
