...
// Runtime: 159 ms, faster than 16.32% of JavaScript online submissions for Number of Valid Words in a Sentence.
// Memory Usage: 45.8 MB, less than 12.85% of JavaScript online submissions for Number of Valid Words in a Sentence.
...
const getAllIndexOfStr = (str, target) => {
  let accStr = str
...
// getAllIndexOfStr('abcad', 'a') //?
// getAllIndexOfStr('abcada', 'a') //?
// getAllIndexOfStr('abcadadaa', 'a') //?
// getAllIndexOfStr('abadaea', 'a') //?
